...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="Penafian.css"> -->
...
<div class="banner">
  ...
  <div class="text-container">
    ...
    <div class="Penafian">
        <h2>Penafian</h2>
        <p>Kerajaan Malaysia dan Sekolah Kebangsaan Bandar Baru Perda  adalah tidak bertanggungjawab bagi apa-apa kehilangan atau kerugian yang disebabkan oleh penggunaan mana-mana maklumat yang diperoleh dari laman web ini serta tidak boleh ditafsirkan sebagai ejen kepada ataupun syarikat yang disyorkan oleh  Sekolah Kebangsaan Bandar Baru Perda </p></div>
