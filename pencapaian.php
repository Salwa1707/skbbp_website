...
<head>
    ...
    <script src="pencapaian.js" defer></script>
</head>
<style>
* {
    position: center;
...
<h1><img src="img/pencapaian.png" width="40" height="40">Pencapaian</h1>
<div class="privacypolicy">

    <div class="activity-grid">
        <?php
        $stmt = $conn->prepare("SELECT * FROM achievement ORDER BY date DESC LIMIT 20");
        if ($stmt) {
            $stmt->execute();
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class='activity-item'>
                        <table>
                        <tr>
                         <td><img src='img/" . htmlspecialchars($row["image"]) . "' width='50' height='50'></td>
                        <td><div class='activity-details'>
                            <p><strong>$title</strong></p>
                            <p>Tarikh: <em>$date</em></p>
                            <p>Peringkat: <em>$level</em></p>
                                    <p>Pencapaian: <em>$achievement</em></p>
                                    <p>Huraian: <em>$about</em></p>
                            <a href='$url' target='_blank'><button>Selanjutnya...</button></a></td>
                            </tr>
                        </div>
                        </table>
                    </div>";
