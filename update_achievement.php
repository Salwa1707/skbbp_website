...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($file['error'] == UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($imageTmpName, $imageFolder)) {
            ...
            $query = "UPDATE achievement SET title='$title', level='$level', date='$date', about='$about', image='$image', url='$url' WHERE id_no='$id_no'";
        } else {
        ...
        $query = "UPDATE achievement SET title='$title', level='$level', date='$date', about='$about', url='$url' WHERE id_no='$id_no'";
    }
    ...
    $id_no = $_GET['id_no'];
    $query = "SELECT * FROM achievement WHERE id_no='$id_no'";
    $result = mysqli_query($conn, $query);
...
<html lang="en">
<head>
    <title>Kemaskini Pencapaian</title>
</head>
...
<body align="center">
    ...
    <div class="container">
        <form action="update_achievement.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="level" name="level" value="<?php echo $level; ?>" required><br>
            ...
            <table>
                <tr>
                    <td><?php echo "<img src='img/$image' alt='activity image'>" ?></td>
                </tr>
            </table>
            <input type="file" id="image" name="image" accept=".jpg, .jpeg, .png">
            <label for="about">Huraian:</label>
            <input type="text" id="about" name="about" value="<?php echo $about; ?>" required><br>
            <label for="url">Link Youtube/Facebook:</label>
        ...
        <div class="logout-container">
            <form action="achievement_update.php" method="post">
...
<?php
        ...
        echo "<center><h3>Data tidak dijumpai!</h3></center>";
    }
}
?>
